...
; e906e
	...
	dbw BANK(Music_WildBattle), Music_WildBattle ; 0xf5dc5
	...
	dbw BANK(Music_GymLeaderBattle), Music_GymLeaderBattle ; 0xea50d
	dbw BANK(Music_FinalBattle), Music_FinalBattle ; 0xea9c1
